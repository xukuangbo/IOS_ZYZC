...
- (void)layoutSubviews
{
    ...
    if (self.contentMode == STPickerContentModeBottom) {
        ...
        self.buttonLeft.top = self.lineViewDown.bottom + STMarginSmall;
        self.buttonRight.top = self.lineViewDown.bottom + STMarginSmall;
    }
}
...
- (UIButton *)buttonRight
{
    if (!_buttonRight) {
        ...
        CGFloat rightX = self.contentView.width - rightW - self.buttonLeft.left;
        CGFloat rightY = self.buttonLeft.top;
