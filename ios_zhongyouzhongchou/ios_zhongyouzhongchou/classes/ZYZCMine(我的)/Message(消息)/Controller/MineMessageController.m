...
- (NSMutableArray *)messages
{
    if (!_messages) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            model.iconString = @"https://ss1.baidu.com/6ONXsjip0QIZ8tyhnq/it/u=3753260611,1752502375&fm=80";
//            http://zyzc-bucket01.oss-cn-hangzhou.aliyuncs.com/20160414151755123.png
